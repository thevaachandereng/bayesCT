...
test_that("The piecewise exponential simulate are", {
  ...
  expect_equal(pw_exp_sim(hazard = c(0.01, 0.005), n = 100, cutpoint = c(20, 40))$event, rep(1, 100))
...
test_that("The piecewise exponential impute are", {
  ...
  expect_error(pw_exp_impute(time = -0.1, hazard = c(0.02, 0.01, 0.1), cutpoint = c(10, 15))$event, 1)
