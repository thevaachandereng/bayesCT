...
Pilot studies are conducted in small sample size to obtain estimation of parameters for a clinical trial. 
...
Howeever, statisticians need to careful consider the inclusion and exclusion criterias in a trial before completely accepting a trial data to incorporate it in a new trial as an historical data. 
