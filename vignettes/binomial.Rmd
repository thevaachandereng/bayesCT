...
**data_binomial**: The data binomial is a wrapper function for inputting data for analysis of bayesian trial. The **data_binomial** takes three input (**treatment**, **outcome** and **complete**).
