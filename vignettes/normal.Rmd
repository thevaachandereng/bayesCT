...
To allow for early stopping for success or futility, we add interim looks to the design.  We'll check for success or futility at the enrollment of the 350th and 380th subject. Upon adding this interim look requirement, the trial is simulated 5 times to obtain the output. 
...
The above flow was for illustrative purposes. Instead of inputting parameters step by step, the trial parameters can be filled in all at once as illustrated below. The pipe function connects all inputs together and the trial is simulated 5 times to obtain results. 
