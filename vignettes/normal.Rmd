...
* **data_normal** - wrapper function for inputting data with a normal outcome. Inputs:
    ...
    + **outcome** - continuous valued outcome of the trial. Input should be a vector with same lenggth as **treatment**. 
