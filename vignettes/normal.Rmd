...
The default delta used is 0, we set the delta to -7 (i.e $120 - \hat{\mu}_{treatment} < -7$). 
...
To induce variation, we simulated the randomization ratio using block size of 10 and 20 repetitively and 1:1 for control to treatment. 
