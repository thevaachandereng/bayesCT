...
* **piecewise_exponential** - wrapper function for specifying observations. Inputs: 
    + **hazard_treatment** - hazard rate of the treatment group. Required input.
    + **cutoff_treatment** - timepoint cutoff for hazard rate of the treatment group.  Required input. 
    + **hazard_control** - hazard rate of the control group. Default value is NULL.
    + **cutoff_control** - timepoint cutoff for hazard rate of the control group. Default value is NULL. 
